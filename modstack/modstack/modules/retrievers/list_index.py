...
from modstack.modules.rankers import RankArtifacts
...
class ListIndexEmbeddingRetriever(_ListIndexRetriever):
    def __init__(
        ...
        ranker: Module[RankArtifacts, list[Artifact]],
    ...
    def _invoke(self, data: ArtifactQuery, **kwargs) -> list[Artifact]:
        ...
        return self._ranker.invoke(RankArtifacts(
            artifacts,
            top_k=self._top_k,
            **kwargs
        ))
    ...
    async def _ainvoke(self, data: ArtifactQuery, **kwargs) -> list[Artifact]:
        ...
        return await self._ranker.ainvoke(RankArtifacts(
            artifacts,
            top_k=self._top_k,
            **kwargs
        ))
