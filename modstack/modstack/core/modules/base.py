...
class Module(Generic[In, Out], ABC):
    ...
    def __or__(self, other: Union['ModuleLike[Out, Other]', 'ModuleMapping[Out]']) -> 'Module[In, Other]':
        from modstack.core.modules.sequential import Sequential
    ...
    def bind(self, **kwargs) -> 'Module[In, Out]':
        from modstack.core.modules.decorator import Decorator
    ...
    def with_retry(
        ...
        from modstack.core.modules.fault_handling.retry import Retry
        return Retry(
            bound=self,
            retry=retry,
            stop=stop,
    ...
    def with_fallbacks(
        ...
        from modstack.core.modules.fault_handling.fallbacks import Fallbacks
        return Fallbacks(
            bound=self,
            fallbacks=fallbacks,
...
def coerce_to_module(thing: ModuleLike[In, Out]) -> Module[In, Out]:
    from modstack.core.modules.functional import Functional
